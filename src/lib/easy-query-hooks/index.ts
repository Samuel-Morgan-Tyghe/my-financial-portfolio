// @ts-nocheck TODO: Fix Npm type definitions for client return types
import {
...
// Working Example
// export const get = (endpoint, isUnauthenticated = false) =>
//   axios({
//     url: SERVER + endpoint,
//     method: "get",
//     headers: isUnauthenticated ? null : authHeaders(),
//   })
//     .then((response) => {
//       return response;
//     })
...
function getMutationConfigs<TRequest, TResponse>({
  ...
  // Determine which HTTP client to use
  const client = getDefaultClient(method)
